/**
 * Generates public/sw.js — install + driver shell offline fallback (no JS bundle caching).
 */
import fs from 'fs';
...
const swSource = `// AUTO-GENERATED — install SW + driver navigation offline fallback only
...
console.log('[generate-sw] Wrote driver offline-shell sw.js');
