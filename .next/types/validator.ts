...
// Validate ../../app/api/viva/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/viva">> = Specific
  const handler = {} as typeof import("../../app/api/viva/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
